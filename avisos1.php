    ...
    <div class="container-fluid">
      <?php if ($_GET['accion']=='editar') {
              ...
              <div class="col-xs-12">
                <div class="box">
                  ...
                  <div class="content table-responsive table-full-width">
                    <table id="ejemplo" class="table table-hover table-striped">
                      <thead>
                        <th>ID</th>
                        <th>CARGO</th>
                        <th>CONTRATO</th>
        ...
        ?>
                ...
                </div <?php } else if ($_GET['accion']=='borrar-aviso-guardado') {
...
echo '<div class="box"> <div class="box-header"><h2>Mis Avisos Guardados</h2> <div class="content table-responsive table-full-width"> <table class="table table-hover table-striped"> <thead> <tr>  <th>ID</th><th>CARGO</th> <th>LUGAR DE TRABAJO</th> <th>CONTRATO</th> <th>JORNADA LABORAL</th> <th>DESCRIPCION</th> <th>FECHA PUBLICACIÓN</th> <th>ACCIONES</th> </tr> </thead> <tbody>';
  ...
  //IMPRIME ADVERTENCIA SI NO HAY DATOS
   if ($filas==0)echo '<div class="callout callout-warning"> <h4><i class="icon fa fa-warning"></i> No hay Avisos Guardados</h4> <p>Te invitamos a que <a href="avisos.php">revises los avisos</a> y Guardes tus avisos favoritos.</p> </div>';
   
}elseif($_GET['accion']=='postulantes'){
  ...
  ?>
                                ...
                                <div  class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div id='loading' class='overlay'><i class='fa fa-refresh fa-spin'></i></div>
                                            <table id="tabla-dinamica-load"  class="table table-hover table-responsive table-full-width">
                                                <thead>
                                                    <tr>
                                                        <th>Nombre</th>
                                                        <th>Apellido</th>
    ...
    <?php
} else { $var_trabajo=$obj_trabajo ->obtieneUltimosTrabajos(); $var_cantidad_trabajos=count($var_trabajo); ?>
