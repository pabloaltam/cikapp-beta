                        ...
                        <div class="col-md-8 col-md-offset-2">
                           ...
                           <button type="button" class="btn btn-info btn-fill" data-toggle="popover" 
                                   ...
                                   data-content="Nace con el fin de crear una nueva economía donde el éxito se mida por el bienestar de los individuos, 
                                                 ...
                                                 fortaleciendo las Empresas B.">No lo conozco</button>
                        </div>
                    </div>
                </div>
            </div>  
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 column">
                          <div class="title">
                            <h4><i class="fa fa-user"></i>&nbsp;&nbsp;Personas</h4>
...
<li>Inteligente filtro de búsqueda</li>
<li>Oportunidad de interactuar con usuarios</li>
<li>Modalidad video-presentación</li>
<li>Postular a avisos destacados</li>
<li>Tu rut y correo es lo que necesitas para registrarte</li>
                          </ul>
                            
                        </div>
                        <div class="col-md-6 column">
                          <h4><i class="fa fa-briefcase"></i>&nbsp;&nbsp;&nbsp;Empresas</h4>
                            <ul>
                           <li>Avisos destacados</li> 
                          <li>El mejor filtro de búsqueda para usuarios</li>
                          <li>Posibilidad de ver a los postulantes en video-presentación</li>
                          <li>Ver postulantes por publicación</li>
                          </ul>
